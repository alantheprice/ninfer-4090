// 9B twin of q4_linear_swiglu_gemv.cu (generated: dims substituted).
...
void q4_linear_swiglu_gemv_pair_launch_9b(const Tensor& x, const Weight& w, Tensor& out,
    ...
    if (w.n != kN || w.k != kK || w.padded_shape[1] != kK) {
        throw std::invalid_argument("q4 linear_swiglu GEMV requires weight [24576,4096] (9B)");
    }
