...
void linear_swiglu(const Tensor& x, const Weight& gate_up_weight, Tensor& out, LinearPolicy policy,
    ...
    const bool shape_9b = x.ne[0] == 4096 && out.ne[0] == 12288 && gate_up_weight.n == 24576 &&
    ...
    if (t <= 0 || x.ne[2] != 1 || x.ne[3] != 1 || out.ne[1] != t || out.ne[2] != 1 ||
        out.ne[3] != 1 || (!large_shape && !w8_shape && !shape_9b)) {
    ...
    const bool q4_weight = (large_shape || shape_9b) &&
