...
from tools.convert.qwen3_5_9b import official_resources
...
def encode_tensor_payload(
    ...
    # The 9B checkpoint stores gdn/norm in float32; the artifact contract is BF16.
    if spec.name.endswith("gdn/norm") and spec.format == inventory.BF16:
